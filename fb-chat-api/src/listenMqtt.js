...
function parseDelta(defaultFuncs, api, ctx, globalCallback, v) {
      ...
      if (i == (v.delta.attachments || []).length) {
        ...
        try {
          ...
          return globalCallback({
            error:
              "Problem parsing message object. Please open an issue at https://github.com/ntkhang03/fb-chat-api/issues.",
            detail: err,
            res: v,
            type: "parse_error",
          });
        ...
        if (delta.deltaMessageReaction && !!ctx.globalOptions.listenEvents) {
          (function () {
            globalCallback(null, {
              ...
              senderID:
                delta.deltaMessageReaction.senderId == 0
                  ? delta.deltaMessageReaction.userId.toString()
                  : delta.deltaMessageReaction.senderId.toString(),
              userID: (
                delta.deltaMessageReaction.userId ||
                delta.deltaMessageReaction.senderId
              ).toString(),
            });
          })();
        } else if (
          ...
          (function () {
            globalCallback(null, {
              ...
              threadID: (delta.deltaRemoveMessage.threadKey.threadFbId
                ? delta.deltaRemoveMessage.threadKey.threadFbId
                : delta.deltaRemoveMessage.threadKey.otherUserFbId
              ).toString(),
              messageID:
                delta.deltaRemoveMessage.messageIds.length == 1
                  ? delta.deltaRemoveMessage.messageIds[0]
                  : delta.deltaRemoveMessage.messageIds,
          ...
          const callbackToReturn = {
            ...
            participantIDs: (
              delta.deltaMessageReply.message.messageMetadata.cid
                .canonicalParticipantFbids ||
          ...
          if (delta.deltaMessageReply.repliedToMessage) {
            ...
            return defaultFuncs
              ...
              .finally(function () {
                ...
                (callbackToReturn.senderID === ctx.i_userID ||
  ...
  switch (v.delta.class) {
            ...
            if (utils.getType(fetchData) == "Object") {
              ...
              switch (fetchData.__typename) {
                case "ThreadImageMessage":
                  (!ctx.globalOptions.selfListenEvent &&
                    (fetchData.message_sender.id.toString() === ctx.i_userID ||
    ...
    case "ApprovalQueue":
      ...
      return (!ctx.globalOptions.selfListenEvent &&
        (formattedEvent.author.toString() === ctx.i_userID ||
...
function getSeqId(defaultFuncs, api, ctx, globalCallback) {
  const jar = ctx.jar;
  utils
    .get("https://www.facebook.com/", jar, null, ctx.globalOptions, {
      noRef: true,
    })
